...
RSpec.describe User, type: :model do
  ...
  describe 'validations' do
    ...
    it { is_expected.to validate_presence_of(:last_name).allow_nil }
    it { is_expected.to validate_presence_of(:middle_name).allow_nil }
    it { is_expected.to validate_presence_of(:first_name).allow_nil }
    it { is_expected.to validate_presence_of(:phone).allow_nil }
    ...
    it { is_expected.to validate_presence_of(:status).allow_nil }
    #it { is_expected.to validate_inclusion_of(:gender).in_array(['Male', 'Female']).allow_nil }
  end
