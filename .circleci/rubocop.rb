...
module DirtyCop
  ...
  def process_bribe
    ...
    cover_up_unmodified ref, only_changed_lines: only_changed_lines
  end
...
module RuboCop
  ...
  class Runner
    ...
    def inspect_file(processed_source, team = mobilize_team(processed_source))
      offenses, updated = inspect_file_unpatched(processed_source, team)
...
puts "Rubocop version: #{Gem.loaded_specs["rubocop"].version}"
